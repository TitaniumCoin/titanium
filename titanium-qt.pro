...
contains(TITANIUM_NEED_QT_PLUGINS, 1) {
    DEFINES += TITANIUM_NEED_QT_PLUGINS
...
HEADERS += src/qt/titaniumgui.h \
    ...
    src/qt/titaniumaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/titanium.cpp \
    src/qt/titaniumgui.cpp \
    ...
    src/qt/titaniumaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/titaniumstrings.cpp \
    src/qt/titaniumamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
contains(TITANIUM_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = titanium-qt_test
DEFINES += TITANIUM_QT_TEST
...
# also add new translations to src/qt/titanium.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/titanium_*.ts)
...
win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/titanium-qt.rc
...
macx:ICON = src/qt/res/icons/titanium.icns
