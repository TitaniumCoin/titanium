...
{
    BOOST_CHECK(TestSplitHost("www.titaniumcoin.net", "www.titaniumcoin.net", -1));
    BOOST_CHECK(TestSplitHost("[www.titaniumcoin.net]", "www.titaniumcoin.net", -1));
    BOOST_CHECK(TestSplitHost("www.titaniumcoin.net:80", "www.titaniumcoin.net", 80));
    BOOST_CHECK(TestSplitHost("[www.titaniumcoin.net]:80", "www.titaniumcoin.net", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:3041", "127.0.0.1", 3041));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:3041", "127.0.0.1", 3041));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:3041", "::ffff:127.0.0.1", 3041));
    BOOST_CHECK(TestSplitHost("[::]:3041", "::", 3041));
    BOOST_CHECK(TestSplitHost("::3041", "::3041", -1));
    BOOST_CHECK(TestSplitHost(":3041", "", 3041));
    BOOST_CHECK(TestSplitHost("[]:3041", "", 3041));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:3041", "127.0.0.1:3041"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:3041", "[::]:3041"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
