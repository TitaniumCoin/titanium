...
// for both titaniumd and titanium-qt, to make it harder for attackers to
// target servers or GUI users specifically.
const std::string CLIENT_NAME("Titanium");
...
#ifdef GIT_ARCHIVE
#    define GIT_COMMIT_ID "-TTN"
#    define GIT_COMMIT_DATE "Mar 11 2014, 11:11:11" // "$Format:%cD"
#endif
