...
#ifndef H_TITANIUM_SCRIPT
#define H_TITANIUM_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CTitaniumAddress
 */
...
public:
    ...
    // Pre-version-0.6, Titanium always counted CHECKMULTISIGs
