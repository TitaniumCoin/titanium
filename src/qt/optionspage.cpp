    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new TitaniumUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->titaniumAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Titanium."), QMessageBox::Ok);
