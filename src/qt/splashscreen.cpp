    ...
    QSplashScreen(pixmap, f)
{
    ...
    //QString copyrightText   = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("Titanium Developers"));
	QString copyrightText   = QChar(0xA9)+QString(" 2013-%1 ").arg("2014") + QString(tr("Titanium Developers"));
