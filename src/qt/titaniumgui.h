#ifndef TITANIUMGUI_H
#define TITANIUMGUI_H
...
/**
  Titanium GUI main class. This class represents the main window of the Titanium UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TitaniumGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TitaniumGUI(bool fIsTestnet = false, QWidget *parent = 0);
    ~TitaniumGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a Titanium wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
