...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(TitaniumUnits::TTN)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = TitaniumUnits::formatWithUnit(unit, amount, true);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(qint64 balance, qint64 unconfirmedBalance, qint64 immatureBalance)
{
    ...
    ui->labelUnconfirmed->setText(TitaniumUnits::formatWithUnit(unit, unconfirmedBalance));
    ui->labelImmature->setText(TitaniumUnits::formatWithUnit(unit, immatureBalance));
