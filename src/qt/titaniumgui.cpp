 ...
 * The Titanium Developers 2011-2012
 */

#include "titaniumgui.h"
...
const QString TitaniumGUI::DEFAULT_WALLET = "~Default";

TitaniumGUI::TitaniumGUI(bool fIsTestnet, QWidget *parent) :
    QMainWindow(parent),
    ...
    prevBlocks(0)
{
    ...
    if (!fIsTestnet)
    {
        setWindowTitle(tr("Titanium") + " - " + tr("Wallet"));
        QApplication::setWindowIcon(QIcon(":icons/titanium"));
        setWindowIcon(QIcon(":icons/titanium"));
    }
    else
    {
        setWindowTitle(tr("Titanium") + " - " + tr("Wallet") + " " + tr("[testnet]"));
        QApplication::setWindowIcon(QIcon(":icons/titanium_testnet"));
        setWindowIcon(QIcon(":icons/titanium_testnet"));
    }
#else
    ...
    if (!fIsTestnet)
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/titanium"));
    else
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/titanium_testnet"));
#endif
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void TitaniumGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Titanium address"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/titanium"), tr("&About Titanium"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/titanium_testnet"), tr("&About Titanium"), this);
    aboutAction->setStatusTip(tr("Show information about Titanium"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Titanium"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    if (!fIsTestnet)
        toggleHideAction = new QAction(QIcon(":/icons/titanium"), tr("&Show / Hide"), this);
    else
        toggleHideAction = new QAction(QIcon(":/icons/titanium_testnet"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Titanium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Titanium addresses"));
...
void TitaniumGUI::createMenuBar()
{
#ifdef Q_OS_MAC
...
void TitaniumGUI::createToolBars()
{
...
void TitaniumGUI::setClientModel(ClientModel *clientModel)
{
...
void TitaniumGUI::setWalletModel(WalletModel *walletModel)
{
...
void TitaniumGUI::createTrayIcon()
{
#ifndef Q_OS_MAC
    trayIcon = new QSystemTrayIcon(this);

    trayIcon->setToolTip(tr("Titanium client"));
...
void TitaniumGUI::createTrayIconMenu()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
...
#ifndef Q_OS_MAC
void TitaniumGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void TitaniumGUI::saveWindowGeometry()
{
    QSettings settings;
...
void TitaniumGUI::restoreWindowGeometry()
{
    QSettings settings;
...
void TitaniumGUI::optionsClicked()
{
...
void TitaniumGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Titanium network", "", count));
}

void TitaniumGUI::setNumBlocks(int count, int nTotalBlocks)
{
...
void TitaniumGUI::message(const QString &title, const QString &message, unsigned int style, bool *ret)
{
    QString strTitle = tr("Titanium"); // default title
...
void TitaniumGUI::changeEvent(QEvent *e)
{
...
void TitaniumGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void TitaniumGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        "which goes to the nodes that process your transaction and helps to support the network. "
        "Do you want to pay the fee?").arg(TitaniumUnits::formatWithUnit(TitaniumUnits::TTN, nFeeRequired));
...
//void TitaniumGUI::incomingTransaction(const QString& date, int unit, qint64 amount, const QString& type, const QString& address)
void TitaniumGUI::incomingTransaction(const QModelIndex& parent, int start, int /*end*/)
{
    ...
    message((amount)<0 ? tr("Sent transaction") : tr("Incoming transaction"),
             tr("Date: %1\n"
                ...
                "Address: %4\n")
                  .arg(date)
                  .arg(TitaniumUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                  .arg(type)
                  .arg(address), CClientUIInterface::MSG_INFORMATION);
}

void TitaniumGUI::gotoOverviewPage()
{
...
void TitaniumGUI::gotoHistoryPage()
{
...
void TitaniumGUI::gotoAddressBookPage()
{
...
void TitaniumGUI::gotoReceiveCoinsPage()
{
...
//void TitaniumGUI::gotoSendCoinsPage(QString addr)
void TitaniumGUI::gotoSendCoinsPage()
{
...
void TitaniumGUI::gotoSignMessageTab(QString addr)
{
...
void TitaniumGUI::gotoVerifyMessageTab(QString addr)
{
...
void TitaniumGUI::gotoServiceMessagesPage()
{
...
void TitaniumGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void TitaniumGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
	    ...
	    gotoSendCoinsPage();
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Titanium address or malformed URI parameters."),
...
bool TitaniumGUI::eventFilter(QObject *object, QEvent *event)
{
...
void TitaniumGUI::resizeEvent(QResizeEvent *e)
{
    updateMask();
    QMainWindow::resizeEvent(e);
}

void TitaniumGUI::paintEvent(QPaintEvent *e)
{
    Q_UNUSED(e);
...
void TitaniumGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void TitaniumGUI::menuFileRequested()
{
    QMenu menu(this);
...
void TitaniumGUI::menuOperationsRequested()
{
    QMenu menu(this);
    QAction* send = menu.addAction(tr("Send Titaniums"));
    QAction* receive = menu.addAction(tr("Receive Titaniums"));
...
void TitaniumGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void TitaniumGUI::encryptWallet(bool status)
{
    if(!walletModel)
        return;
...
void TitaniumGUI::changePassphrase()
{
...
void TitaniumGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void TitaniumGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void TitaniumGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

void TitaniumGUI::onMiningClicked()
{
    //ui->wMining->setStyleSheet("background-color:black;");
    centralWidget->setCurrentWidget(miningPage);
}

void TitaniumGUI::on_bHelp_clicked()
{    
    rpcConsole->show();
}
