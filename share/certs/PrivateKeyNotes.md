...
unlocked to sign the Titanium-Qt.app bundle.
...
allowing somebody to distribute a Titanium-Qt.app or titanium-qt-setup.exe with a valid
...
that the titanium-qt.exe file inside the installer had not been tampered with.
