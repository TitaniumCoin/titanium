...
WORKINGDIR="/tmp/titanium"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/titaniumcoin/titanium/titanium-0.9.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/TitaniumCoin/titanium/"
VERSIONPREFIX="titanium-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'titanium-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[titanium-]<version>-[rc[0-9]] (example: titanium-0.7.1-rc1)"
   echo "wget output:"
